...
import torch
from network_architecture.custom.layers.factories import Act, Dropout, Norm, Pool, split_args
from network_architecture.custom.utils.misc import has_option
...
def get_act_layer(name: Union[Tuple, str]):
    ...
    .. code-block:: python
        ...
        from network_architecture.custom.layers.utils import get_act_layer
...
def get_dropout_layer(name: Union[Tuple, str, float, int], dropout_dim: Optional[int] = 1):
    ...
    .. code-block:: python
        ...
        from layers import get_dropout_layer
...
def get_pool_layer(name: Union[Tuple, str], spatial_dims: Optional[int] = 1):
    ...
    .. code-block:: python
        ...
        from layers import get_pool_layer
