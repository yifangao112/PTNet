...
class LayerFactory:
    ...
    def add_factory_callable(self, name: str, func: Callable) -> None:
        ...
        self.__doc__ = (
            ...
            + ".\nPlease see :py:class:`layers.split_args` for additional args parsing."
        )
...
def swish_factory():
    from network_architecture.custom.blocks.activation import Swish
...
def memswish_factory():
    from network_architecture.custom.blocks.activation import MemoryEfficientSwish
...
def mish_factory():
    from network_architecture.custom.blocks.activation import Mish
