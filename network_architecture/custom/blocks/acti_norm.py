...
from network_architecture.custom.layers.utils import get_act_layer, get_dropout_layer, get_norm_layer
...
class ADN(nn.Sequential):
    ...
    See also:
        ...
        :py:class:`layers.Dropout`
        :py:class:`layers.Act`
        :py:class:`layers.Norm`
        :py:class:`layers.split_args`
